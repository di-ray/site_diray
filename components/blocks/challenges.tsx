...
const iconMap = {
  CEOs: (
    <svg width="48" height="48" fill="currentColor" viewBox="0 0 75.698 75.698" className="text-white">
      {" "}
      <path
        style={{ fill: "#fffff" }}
  ...
  "Líderes de RH": (
    <svg width="48" height="48" fill="currentColor" viewBox="0 0 64 64" className="text-white">
      {" "}
      <g>
        {" "}
        <g>
          ...
          <rect x="11" y="54" width="2" height="2" /> <rect x="11" y="58" width="2" height="2" />{" "}
          ...
          <rect x="5" y="53" width="2" height="7" /> <rect x="17" y="53" width="2" height="7" />{" "}
          ...
          <rect x="29" y="54" width="2" height="2" /> <rect x="29" y="58" width="2" height="2" />{" "}
          ...
          <rect x="47" y="54" width="2" height="2" /> <rect x="47" y="58" width="2" height="2" />{" "}
          ...
          <rect x="6" width="3" height="2" /> <rect x="11" width="3" height="2" /> <rect x="16" width="3" height="2" />{" "}
          <rect x="21" width="3" height="2" /> <rect x="26" width="3" height="2" /> <rect x="31" width="3" height="2" />{" "}
          <rect x="36" width="3" height="2" /> <rect x="41" width="3" height="2" /> <rect x="46" width="3" height="2" />{" "}
...
export const ChallengesSection = (props) => {
  const { title = "Como a DI.RAY me ajuda?", ceoContent, rhContent, heading, cards } = props;

  // Use props from MDX or fallback to cards structure
  const displayCards = cards || [
    {
      groupTitle: "CEOs",
      content: ceoContent?.items ? ceoContent.items.map(item => `- ${item}`).join('\n') : "- Definição rápida e robusta de metas\n- Plano prático para alinhar a cultura\n- Engajar o time no aprendizado de temas relevantes para o negócio\n- Plano concreto para comunicar projetos e iniciativas\n- Forme seu time em IA focado no que sua organização precisa",
      resultText: ceoContent?.result || "O resultado? Equipe mais eficiente e sua empresa crescendo de forma estruturada."
    },
    {
      groupTitle: "Líderes de RH",
      content: rhContent?.description || "Entregue soluções em performance e cultura (definição de metas, alinhamento de cultura, plano de comunicação, estratégia de treinamento e formação customizada em IA) de maneira rápida, sem precisar de sistemas caros e complexos e capacite seu time para replicar os produtos quantas vezes quiser.",
      resultText: rhContent?.result || "O resultado? Você fortalecendo sua posição e gerando ainda mais impacto na organização."
    }
  ];
          ...
          {displayCards?.map((card, i) => (
            ...
            >
              <div className="flex flex-col items-center mb-6">
                ...
                <h3 data-tina-field={tinaField(card, "groupTitle")} className="text-2xl font-bold text-white">
                  {card.groupTitle}:
                </h3>
              </div>
