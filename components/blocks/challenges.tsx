...
export const ChallengesSection = (props: ChallengesSectionProps) => {
  // Conteúdo padrão do projeto DIRAY original
  const defaultHeading = "Como a DI.RAY me ajuda?"
  const defaultCards = [
    {
      groupTitle: "CEOs",
      content: {
    ...
    },
    {
      ...
      content: {
        ...
        children: [{
          ...
          children: [{
            type: 'text',
            text: 'Entregue soluções em performance e cultura (definição de metas, alinhamento de cultura, plano de comunicação, estratégia de treinamento e formação customizada em IA) de maneira rápida, sem precisar de sistemas caros e complexos e capacite seu time para replicar os produtos quantas vezes quiser.'
          }]
        }]
      },
      resultText: "O resultado? Você fortalecendo sua posição e gerando ainda mais impacto na organização."
    }
  ];
