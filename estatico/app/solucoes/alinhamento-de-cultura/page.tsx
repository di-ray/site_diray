...
export default function AlinhamentoCultura() {
    ...
    <>
      <section className="relative bg-dark min-h-[60vh] flex  py-20 md:py-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div
            className="max-w-3xl text-left" // Changed from text-center sm:text-left to text-left
            ...
            >
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
                  Cultura alinhada,
                  <br className="hidden md:block" /> equipe engajada
                </h2>
              </motion.div>
              <motion.div variants={itemVariants} whileHover={{ scale: 1.02, transition: { duration: 0.3 } }}>
                <p className="text-white text-lg mb-6">
                  Uma cultura organizacional bem alinhada <strong>orienta, engaja e reduz conflitos</strong>{" "}
                  improdutivos, criando um caminho sólido para o futuro desejado pela organização.
                </p>
                <p className="text-white text-lg mb-6">
                  Com o Alinhamento de Cultura você recebe o mapeamento da cultura da sua organização e um plano de ação
                  efetivo para garantir que as ações do dia a dia estejam alinhadas com uma cultura vencedora
                </p>
                <motion.div className="flex flex-col md:flex-row gap-6" variants={containerVariants}>
                  <motion.div className="flex items-center" variants={itemVariants}>
                    ...
                    <span className="text-white">Preço mínimo: R$ 13.800,00</span>
                  </motion.div>
                  <motion.div className="flex items-center" variants={itemVariants}>
                    <Clock className="text-white mr-2" size={20} />
                    <span className="text-white">Duração mínima: 19 dias úteis</span>
                  </motion.div>
                </motion.div>
              </motion.div>
            </motion.div>
      ...
      <MoreSolutions currentPage="/solucoes/alinhamento-de-cultura" />
...
function BudgetCalculator() {
  ...
  const handleLeadSubmit = (data: LeadFormData) => {
    ...
    if (!planDetails) {
      console.error("Detalhes do plano não encontrados. Plano selecionado:", selectedPlan)
      setShowWarning(true)
      return
    }

    const budgetAmount = planDetails.totalCost.toString()
    const leadDataWithBudget = {
      ...data,
      service: "Alinhamento de Cultura",
      budget: budgetAmount,
    }

    console.log("Lead submitted:", leadDataWithBudget)
    setLeadSubmitted(true)
    setShowBudget(true) // Adiciona esta linha para mostrar o orçamento após o envio
  ...
  function generatePDF() {
    ...
    html2canvas(element, {
      ...
      pdf.save("Orçamento-Alinhamento-de-Cultura-DiRay.pdf")
    })
  }
          ...
          >
            ...
            >
              {[
                ...
                { id: "plan2", label: "100 a 1.000 pessoas" },
                { id: "plan3", label: "1.000 a 5.000 pessoas" },
              ].map((plan, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-dark">Alinhamento de Cultura - {planDetails.range}</p>
